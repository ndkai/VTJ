// ignore_for_file: constant_identifier_names, prefer_generic_function_type_aliases, overridden_fields, missing_required_param
...
class RefreshController {
  ...
  RefreshController(
    ...
    headerMode = ValueNotifier(initialRefreshStatus ?? RefreshStatus.idle);
    footerMode = ValueNotifier(initialLoadStatus ?? LoadStatus.idle);
  }
...
class RefreshConfiguration extends InheritedWidget {
  ...
  const RefreshConfiguration(
      ...
      : assert(child != null),
        ...
        assert(dragSpeedRatio > 0), super(key: key);
  ...
  RefreshConfiguration.copyAncestor({Key key,
    ...
    bool hideFooterWhenNotFull,
        ...
        shouldFooterFollowWhenNotFull = shouldFooterFollowWhenNotFull ??
            RefreshConfiguration.of(context).shouldFooterFollowWhenNotFull, super(key: key);

  static RefreshConfiguration of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType(
        aspect: RefreshConfiguration);
  }
