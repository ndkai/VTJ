    ...
    return BasePage(
      ...
      child: ListView(
        children: [
              ...
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                      onTap: (){
                        controller.currentWeek.value = controller.currentWeek.value.previous;
                        controller.getEmployeesAttendance(context);
                      },
                      child: const Icon(Icons.arrow_back_ios, size: 17,color: Colors.black54),
                    ),
                    Obx((){
                          return Text("${Helper.getVietnameseTime(controller.currentWeek.value.days.first.toIso8601String(), showYear: false)} - ${Helper.getVietnameseTime(controller.currentWeek.value.days.last.toIso8601String(),)}", style: const TextStyle(color: Colors.black54, fontSize: 17),);
                        }
                    ),
                    InkWell(
                      onTap: (){
                        controller.currentWeek.value = controller.currentWeek.value.next;
                        controller.getEmployeesAttendance(context);
                      },
          ...
          Wrap(
            children: [
              AttendanceStatusItem(color: Ui.parseColor("#94A3B8"), title: "Không có ca làm việc", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#000000"), title: "Ngày nghỉ", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#A61C4A"), title: "Vắng mặt", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#B9859E"), title: "Không có giờ ra", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#002987"), title: "Không có giờ vào", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#FFBED4"), title: "Chưa đến ca làm việc", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#FFBED4"), title: "Về sớm", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#0037B3"), title: "Về trể", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#05CE91"), title: "Đúng giờ", size: 10,),
              AttendanceStatusItem(color: Ui.parseColor("#41ADD1"), title: "Về đúng giờ", size: 10,),
            ],
          ),
          const SizedBox(height: 20,),
          Obx((){
            ...
            return AttendanceWidget(week: controller.currentWeek.value, employeesAttendance: controller.employeesAttendance,
            deleteSchedule: (s){
