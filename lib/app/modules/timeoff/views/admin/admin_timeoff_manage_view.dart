...
import 'admin_have_salary_do_view.dart';

class AdminTimeOffViewManager extends GetView<TimeOffController> {
  const AdminTimeOffViewManager({Key key}) : super(key: key);
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          bottom: const TabBar(
            tabs: [
              Tab(icon: Text('Tất cả',
                style: TextStyle(fontSize: 13, color: Colors.white),)),
              Tab(icon: Text('Chờ duyệt',
                style: TextStyle(fontSize: 13, color: Colors.white),)),
              Tab(icon: Text('Thành công',
                style: TextStyle(fontSize: 13, color: Colors.white),)),
              Tab(icon: Text('Từ chối',
                style: TextStyle(fontSize: 13, color: Colors.white),)),
            ],
            indicatorColor: Colors.white,
          ),
          title: const Text(
            'Quản lý nghỉ phép', style: TextStyle(fontSize: 24),),
          centerTitle: true,
  ...
  Widget rowField(String title, String content,
    ...
    return Row(
      ...
      children: [
        Text(
          title, style: const TextStyle(color: Colors.black45, fontSize: 16),),
        Text("$content       ",
